...
app.controller('Analytics', ['$scope', '$http', function ($scope,$http) {
	$scope.go = function() {
		...
		var options = {
			...
			filters: '&filters%5Bdate_approved%5Bfrom%5D%5D=' + start_date + '&filters%5Bdate_approved%5Bto%5D%5D=' + end_date +'&filters%5B_committee%5D=1553&filters%5Bprogrammes%5D%5B%5D=1&per_page=200',
			sub_filter: '&page='
		};		

		//oGV
 			if(programa == '1'){
			options.filters = '&filters%5Bdate_approved%5Bfrom%5D%5D=' + start_date + '&filters%5Bdate_approved%5Bto%5D%5D='+ end_date + '&filters%5Bperson_committee%5D=1553&filters%5Bprogrammes%5D%5B%5D=1&per_page=200'
		}//oGT
		else if(programa == '2'){
			options.filters = '&filters%5Bdate_approved%5Bfrom%5D%5D=' + start_date + '&filters%5Bdate_approved%5Bto%5D%5D='+ end_date + '&filters%5Bperson_committee%5D=1553&filters%5Bprogrammes%5D%5B%5D=2&per_page=200'	//OGT
		}//oGE
		else if(programa == '3'){
			options.filters = '&filters%5Bdate_approved%5Bfrom%5D%5D=' + start_date + '&filters%5Bdate_approved%5Bto%5D%5D='+ end_date + '&filters%5Bperson_committee%5D=1553&filters%5Bprogrammes%5D%5B%5D=5&per_page=200'	//OGT
		}//iGV
		else if(programa == '4'){
			...
			options.filters = '&filters%5Bdate_approved%5Bfrom%5D%5D=' + start_date + '&filters%5Bdate_approved%5Bto%5D%5D='+ end_date + '&filters%5Bopportunity_committee%5D=1553&filters%5Bprogrammes%5D%5B%5D=2&per_page=200'	//iGV
		}//iGE
		else{
			options.filters = '&filters%5Bdate_approved%5Bfrom%5D%5D=' + start_date + '&filters%5Bdate_approved%5Bto%5D%5D='+ end_date + '&filters%5Bopportunity_committee%5D=1553&filters%5Bprogrammes%5D%5B%5D=5&per_page=200'	//iGT
		}
