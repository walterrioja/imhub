...
app.controller('Analytics', ['$scope', '$http', function ($scope,$http) {
	$scope.go = function() {
		...
		//iGV
 		if(programa == '1'){
 			options.filters = '&filters%5Bdate_matched%5Bfrom%5D%5D=' + start_date + '&filters%5Bdate_matched%5Bto%5D%5D=' + end_date + '&filters%5Bopportunity_committee%5D=1553&filters%5Bprogrammes%5D%5B%5D=1&per_page=200&sort=status'
			...
			options.filters = '&filters%5Bdate_matched%5Bfrom%5D%5D=' + start_date + '&filters%5Bdate_matched%5Bto%5D%5D=' + end_date + '&filters%5Bopportunity_committee%5D=1553&filters%5Bprogrammes%5D%5B%5D=2&per_page=200&sort=status'
